/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 3102b2e9edd4708554971fc5bf0eb5dd)
// Runtime types generated with workerd@1.20260820.1 2026-06-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SELF: Fetcher /* test-results-dashboard-web */;
