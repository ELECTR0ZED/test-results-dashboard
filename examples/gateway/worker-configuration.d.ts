/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f6f8d2ab32b6c3d2c2ec620fca26a79f)
// Runtime types generated with workerd@1.20260611.1 2025-11-04 nodejs_compat
interface __BaseEnv_Env {
	WEB: Fetcher /* test-results-dashboard-web */;
	API_INGEST: Fetcher /* test-results-dashboard-api-ingest */;
	API_DASHBOARD: Fetcher /* test-results-dashboard-api-dashboard */;
}
