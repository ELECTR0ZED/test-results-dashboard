/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 4bf8e0d9f4f9aebb198afbd616fe8006)
// Runtime types generated with workerd@1.20260611.1 2025-03-25 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SELF: Service<typeof import('./.open-next/worker').default>;
	API: Fetcher /* test-results-dashboard-api-dashboard */;
}
